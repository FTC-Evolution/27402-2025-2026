...
@Autonomous(name="Mode Autonome Avancer")
public class RunForward extends LinearOpMode {
    ...
    static final String[] possiblePaths = {"avancer", "reculer","practice","crabeLEFT", "crabeRIGHT", "tournerCLOCK", "tournerCOUNTER","one","short","testCombo","richel"};
    int currentPath = 0;
